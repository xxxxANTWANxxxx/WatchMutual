...
export class SearchResultsPage implements OnInit
{
  ...
  constructor(private http: HttpClient, private route: ActivatedRoute, private modalController: ModalController, private alertController: AlertController) { }
  ...
  async displayListSelect(string, int)
  {
    this.loadLists();
    var inputs = [];
      ...
      inputs.push(
        {
          name: i,
          type: 'radio',
          label: this.allData[i].listName,
          value: this.allData[i].lid,
        }
      )
    }
