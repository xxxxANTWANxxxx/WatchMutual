  ...
  loadPeople()
  {
    ...
    this.http.post("http://localhost:4200/add-friends", postData, httpOptions)
      .subscribe(fdata =>
      {
        ...
        for (let i = 0; i < this.add.length; i++)
        {
          if (this.add[i].pic != null)
            this.add[i].pic = arrayBufferToBase64(this.add[i].pic.data)
          else this.add[i].pic = ""
        }
      }, error =>
        {
          console.log('failure')
